        ...
        <div className="mb-28 mt-16">
            {products.length > 0 ?
                <div>
                    ...
                    <Carousel className="" autoPlay infiniteLoop interval={2000} showArrows={false}>
                        <div>
                            <img src={products[0].image} alt="Image 1" />
                        </div>
                        <div>
                            <img src={products[1].image} alt="Image 2" />
                        </div>
                        <div>
                            <img src={products[2].image} alt="Image 3" />
                        </div>
                    </Carousel>
